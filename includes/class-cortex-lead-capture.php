...
class Cortex_Lead_Capture {
    ...
    public function __construct() {
        global $wpdb;
        $this->db = $wpdb;
        $this->table_leads = $wpdb->prefix . 'cortex_lead_captures';
    }
     ...
     * @param array $data Lead data (sanitized externally via Cortex_Security)
    ...
    public function capture_lead( $quiz_id, $attempt_id, $data ) {
        ...
        $insert_data = array(
            ...
            'consent_given' => 1,
            'ip_address'    => isset( $data['ip_address'] ) ? $data['ip_address'] : Cortex_Security::get_user_ip(),
