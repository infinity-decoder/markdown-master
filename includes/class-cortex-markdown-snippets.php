<?php
/**
 * Markdown Snippets Management for Cortex
 * 
...
class Cortex_Markdown_Snippets {
    ...
    public function __construct() {
        global $wpdb;
        $this->db = $wpdb;
        $this->table = $wpdb->prefix . 'cortex_markdown_snippets';
    }
    ...
    public function update_snippet( $id, $data ) {
        ...
        // Clear cache
        Cortex_Cache::delete( 'md_snippet_' . $id, Cortex_Cache::GROUP_MARKDOWN );
    ...
    public function get_snippet( $id ) {
        ...
        $row = Cortex_Cache::get( $cache_key, Cortex_Cache::GROUP_MARKDOWN );
        ...
        if ( false === $row ) {
            ...
            if ( $row ) {
                Cortex_Cache::set( $cache_key, $row, Cortex_Cache::get_ttl(), Cortex_Cache::GROUP_MARKDOWN );
            }
        }
