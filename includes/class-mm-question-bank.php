<?php
/**
 * Question Bank Management for Markdown Master
 * 
...
class MM_Question_Bank {
    ...
    public function __construct() {
        global $wpdb;
        $this->db = $wpdb;
        $this->table_banks = $wpdb->prefix . 'mm_question_bank';
        $this->table_bank_items = $wpdb->prefix . 'mm_question_bank_items';
    }
     ...
     * 
     * @param int $bank_id Bank ID
     * @param array $question_data Question data (sanitized externally via MM_Security)
