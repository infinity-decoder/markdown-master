...
class Cortex_Cache {
     ...
     * Cache groups
     */
    const GROUP_QUIZ = 'cortex_quiz';
    const GROUP_QUESTION = 'cortex_question';
    const GROUP_MARKDOWN = 'cortex_markdown';
    const GROUP_CODE = 'cortex_code';
    const GROUP_RESULT = 'cortex_result';
    ...
    public static function get_ttl() {
        $ttl = get_option( 'cortex_cache_ttl', self::DEFAULT_TTL );
        return absint( $ttl );
    }
